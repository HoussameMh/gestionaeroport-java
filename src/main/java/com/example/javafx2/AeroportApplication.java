...
public class AeroportApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        // Initialize the gestion_aeroport controller
        aeroport = new gestion_aeroport();
        
        // Create TabPane for navigation
        TabPane tabPane = new TabPane();
        
        // Tab 1: Gestion des Vols
        ...
        // Ajouter des écouteurs pour rafraîchir les données quand on change d'onglet
